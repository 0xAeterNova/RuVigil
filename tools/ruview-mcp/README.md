...
**SENSE-BRIDGE** is a dual-transport [Model Context Protocol](https://modelcontextprotocol.io/) (MCP) server that bridges the RuVigil sensing stack to AI agents (Claude Code, Cursor, ruflo swarms, and any MCP-compatible client).
...
Original upstream tracking issue: #787.
