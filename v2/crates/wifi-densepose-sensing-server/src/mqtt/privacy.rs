...
//! set, biometric channels (HR, BR, body temperature, raw pose keypoints) are stripped
...
mod tests {
    ...
    fn privacy_on_suppresses_biometrics_only() {
        ...
        assert_eq!(decide(EntityKind::BodyTemperature, true), PublishDecision::Suppress);
