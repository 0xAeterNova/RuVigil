...
/// NOT in the table (HR / BR / body temperature / pose / motion_energy / presence_score)
...
/// cluster represents them (HR / BR / body temperature / pose / motion_energy / presence_score).
...
mod tests {
    ...
    fn biometric_entities_have_no_matter_exposure() {
        ...
        assert!(matter_mapping(EntityKind::BodyTemperature).is_none());
