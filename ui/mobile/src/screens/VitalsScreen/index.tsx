...
export default function VitalsScreen() {
  ...
  const bodyTemperatureC = usePoseStore((state) => state.lastFrame?.vital_signs?.body_temperature_c);
  ...
  return (
    <ThemedView style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <MetricCard
          label="Body Temp"
          value={typeof bodyTemperatureC === 'number' && bodyTemperatureC > 0 ? bodyTemperatureC : '--'}
          unit="C"
          color={colors.warn}
        />
        <MetricCard
