...
**Camera-free room awareness from your phone.** Real-time WiFi sensing, vital signs, and care workflows in a cross-platform mobile app.

RuVigil Mobile is a React Native / Expo companion app for the [RuVigil](../../README.md) sensing platform. It connects to a WiFi sensing server over WebSocket, renders live 3D Gaussian splat visualizations of detected humans, displays body temperature, breathing, and heart rate in real time, and provides care-oriented triage views from a single codebase that runs on iOS, Android, and Web.
...
<!-- ![RuVigil Mobile](assets/screenshots/app-overview.png) -->
...
| RuVigil Server | Any | Optional - app falls back to simulated data without a server |
...
The app connects to the RuVigil sensing server over WebSocket for live data. Configure the server URL in the **Settings** tab.
...
Built on the [RuVigil](../../README.md) sensing platform.
