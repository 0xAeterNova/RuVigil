/**
 * RuVigil Observatory - Main Scene Orchestrator
 *
 * Room-based WiFi sensing visualization with:
 * - Pool of 8 human wireframe figures (multi-person scenarios)
...
class Observatory {
  ...
  _buildRoom() {
    this._grid = new THREE.GridHelper(12, 24, 0x17645e, 0x0c2b34);
