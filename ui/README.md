...
A modular web interface for the RuVigil camera-free room monitoring system. Provides real-time occupancy, fall detection, body temperature, heart rate, respiratory rate, sleep monitoring, and CSI visualization.
...
Part of the RuVigil fork profile. See the main project LICENSE file.
