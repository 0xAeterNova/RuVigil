 ...
 * the physically-defensible parts onto RuVigil's three-tier heartbeat
  ...
  override render() {
    return html`
      ...
      <div class="subtitle">
        ...
        CIA NV-diamond heartbeat detector, and how RuVigil's existing
      ...
      <h2>RuVigil's three-tier mesh — what is actually buildable</h2>
      ...
      <h2>Press claim → RuVigil equivalent</h2>
      <div class="card" style="padding: 6px 14px;">
        <table>
          <thead>
            <tr><th>Press claim</th><th>RuVigil equivalent today</th><th>Crate / ADR</th><th>Honest range</th></tr>
          </thead>
          <tbody>
            <tr>
      ...
      <div class="ethics">
        ...
        <ul>
          ...
          <li><b>No export-controlled hardware</b> — RuVigil targets &lt; $50 COTS. ITAR/EAR sub-THz coherent radars and shielded NV ensembles are out of scope.</li>
        </ul>
        <p style="font-size: 11.5px; color: var(--ink-3); margin: 10px 0 0;">
          RuVigil is not affiliated with the United States government, the CIA, Lockheed Martin,
