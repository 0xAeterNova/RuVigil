...
const GLOSSARY: GlossaryItem[] = [
  ...
  { term: 'Multistatic fusion', category: 'physics', body: 'Combining evidence from multiple sensors at known geometric configurations. RuVigil\'s Cramer-Rao-weighted attention over WiFi CSI nodes + 60 GHz radar nodes + (hypothetically) NV nodes; documented in ADR-029 and the Ghost Murmur view.' },
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Because nvsim is one tile in a larger sensing platform. The catalog lists every hot-loadable WASM edge module RuVigil ships — medical, security, building, retail, industrial, signal, learning, autonomy. The simulators (nvsim today, more in future) are first-class entries in the same catalog.',
  },
];
  ...
  private renderAbout() {
    return html`
      ...
      <p>The codebase is open source (Apache-2.0 OR MIT). Find it on GitHub:
        <code>RuVigil fork profile</code>. Decisions are documented in ADRs 089 (nvsim),
        090 (Lindblad extension, conditional), 091 (sub-THz radar research),
        092 (this dashboard), 093 (UX gap analysis).</p>
      <p>This dashboard is one of several RuVigil demos. Sibling demos include
        the Observatory and Pose Fusion views.</p>
    `;
  }
